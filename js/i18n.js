...
const I18N = (function () {
    ...
    const translations = {
        pl: {
            ...
            // Auth
            authSubtitle: 'Zaloguj się, aby śledzić swoje inwestycje',
            authEmail: 'Email',
            authPassword: 'Hasło',
            authPasswordConfirm: 'Potwierdź hasło',
            ...
            authLogout: 'Wyloguj',
            authErrFillFields: 'Wypełnij wszystkie pola',
            authErrPasswordMismatch: 'Hasła nie są takie same',
            authErrPasswordShort: 'Hasło musi mieć min. 6 znaków',
            authErrEmailInUse: 'Ten email jest już zarejestrowany',
            authErrInvalidEmail: 'Nieprawidłowy adres email',
            authErrUserNotFound: 'Nie znaleziono konta z tym emailem',
            authErrWrongPassword: 'Nieprawidłowe hasło',
            authErrTooMany: 'Zbyt wiele prób. Spróbuj później',
            authErrNetwork: 'Błąd sieci. Sprawdź połączenie',
        ...
        en: {
            ...
            // Auth
            authSubtitle: 'Sign in to track your investments',
            authEmail: 'Email',
            ...
            authLogout: 'Log out',
            authErrFillFields: 'Please fill in all fields',
